...
Ưu tiên: Từ N4-N3-N2-N1, từ business phổ biến, từ frequency cao. KHÔNG lấy từ N5 hoặc N4 quá đơn giản.
...
## OUTPUT FORMAT
**QUAN TRỌNG: Trả về JSON THUẦN (pure JSON). KHÔNG markdown, KHÔNG code blocks.**
